...
namespace DishBurger.Data.Cart
{
    public class ShoppingCart
    {
        ...
        {
            return ShoppingCartItems ?? (ShoppingCartItems = _context.ShoppingCartItems.Where(n => n.ShoppingCartId == ShoppingCartId).Include(n => n.Item.Dish).ToList());
        }
